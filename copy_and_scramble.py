...
#
# 2. I was seeing the following error: ValueError: Too many arguments provided to bind() (got 1507, expected 227)
# this is because the prepared statement doesnt like a string sequence you need either a list or tuple
